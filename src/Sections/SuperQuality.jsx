  ...
  return (
    ...
    >
      ...
      font-bold"
        ...
        <p className="mt-6 lg:max-w-lg info-text">Our Dedication to  detail and excellence ensuresyour satisfaction</p>
       <div  className="mt-11">
      ...
      <div className="flex-1 flex justify-center items-center">
        <img src={shoe8} alt="8" width={570} height={522} className="object-contain" />
      </div>
    </section>
  );
};
